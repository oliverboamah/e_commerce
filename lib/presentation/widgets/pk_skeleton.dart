...
class PKGridCardSkeleton extends StatefulWidget {
  final bool isBottomLinesActive;
  PKGridCardSkeleton({this.isBottomLinesActive = true});
  @override
  _PKGridCardSkeletonState createState() => _PKGridCardSkeletonState();
}

class _PKGridCardSkeletonState extends State<PKGridCardSkeleton>
...
class PKGridCardListSkeleton extends StatelessWidget {
  final bool isBottomLinesActive;
  final int length;
